            ...
            <div className="content">
              ...
              <div className="text-content">
                ...
                <p>
                  ...
                  <p>a. those with a diagnosis from a specialist (11 conditions) and </p>
                  b. those based on manifestation (five conditions). Among the
                  diagnosed conditions, intellectual disability was the most
                  common among elementary students, with 20,377 cases.
                  Regarding manifestation, high prevalence rates were observed
                  for difficulties with vision, as well as challenges in
                ...
                <div className="reference-section">
				  ...
				  <p>[3] Author(s), "Title of the Article," KnE Social Sciences, [Online]. Available: https://kneopen.com/KnE-Social/article/view/10592/. [Accessed: Oct. 23, 2024].</p>
                </div>
              </div>
            </div>
          </div>
